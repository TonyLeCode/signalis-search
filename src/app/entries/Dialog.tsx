...
export default function Dialog() {
	...
	return (
		<>
			<button onClick={clickHandler} className="absolute -right-12 sm:mt-1 bg-primary-red hover:bg-off-white rounded-full" title={'Click to open search'}>
				<svg
	...
	c9.3-9.2,9.3-24.2,0-33.5L412.5,304.3z"
			...
			<dialog
				...
				className="px-2 max-w-5xl w-full mt-2 sm:mt-16 bg-transparent backdrop:cursor-pointer backdrop:bg-zinc-950/90"
			>
